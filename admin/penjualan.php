...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <nav class="huhu">
        <ul>
          ...
          <li>
            <a href="Zcart.html"><i class="fa-solid fa-cart-shopping"></i></a>
          </li>
          <li>
    ...
    <div class="container">
      <aside>
             ...
             39.5 97.5 0 57.81-39.69 97.31-39.68 39.5-97.5 39.5Zm.66 370Q398-80 325-111.5t-127.5-86q-54.5-54.5-86-127.27Q80-397.53 80-480.27
              ...
              31.5 155T848.5-325q-31.5 73-86 127.5t-127.03 86Q562.94-80 480.47-80Zm-.47-60q55 0 107.5-16T691-212q-51-36-104-55t-107-19q-54
               0-107 19t-104 55q51 40 103.5 56T480-140Zm0-370q34 0 55.5-21.5T557-587q0-34-21.5-55.5T480-664q-34 0-55.5 21.5T403-587q0 34
                21.5 55.5T480-510Zm0-77Zm0 374Z"
              />
            </svg>
          </i>
          <p>Admin</p>
        ...
        <div class="nav">
          ...
          <li>
            <a class="pelanggan" href="pelanggan.php"><p>Pelanggan</p></a>
          </li>
          <li>
      ...
      <main>
        <section class="main">
          <div class="judul">Penjualan</div>
          <div class="PENJUALAN-STOK">
            <?php foreach ($baju as $row) : ?>
            <div class="baju-1 baju">
              <img src="../asstes/img/<?php echo $row['gambar']; ?>" alt="" />
              <div class="ket">
                <p><?php echo $row['nama_produk']; ?></p>
                <h3>
                  Terjual:
                  <?php echo $row['terjual']; ?>
                </h3>
                <h3>
                  Stok:
                  <?php echo $row['stok']; ?>
                ...
                <a
                  href="tambahStok.php?id=<?= $row['id']; ?>"
                  onclick="return 
                      confirm('Tambah 1 stok untuk produk ini?');"
                >
                  <button class="btn">Tambah Stok</button>
                </a>
                <a 
                  href="hapusProduk.php?id=<?= $row['id']; ?>"
                  onclick="return 
    ...
    <footer class="admin-footer">
      <p>
        © 2024 NusantaraBatik Admin Dashboard | All rights reserved | Version
        1.0.0
      </p>
    </footer>
  </body>
