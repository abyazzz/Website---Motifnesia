<?php
// =========================
// FILE: status.php (Revisi per checkout_id)
// =========================
...
<body>
  <div class="container">
    <aside>
          ...
          <div class="nav">
            <li>
              <a class="Status" href="Koleksi.php"><p>Koleksi</p></a>
            </li>
            <li>
              <a class="Status" href="penjualan.php"
                ><p>Penjualan & Stok</p></a
              >
            </li>
            <li>
              <a class="Status" href="pelanggan.php"
                ><p>Pelanggan</p></a
              >
            </li>
            <li>
              <a class="status" href="#"><p>Status</p></a>
            </li>
            <li>
              <a class="Status" href="tembah.php"
                ><p>Tambah Produk</p></a
              >
            </li>
          </div>
