...
<body>
    <header>
        ...
        <nav class="huhu">
            <ul>
                <li><a href="../MotifNesia/index.php">Home</a></li>
                <li><a href="dasbord.html">About Us</a></li>
                <li><a href="ZZcontact2.html">Contact</a></li>
                <li><a href="ZZlayanankami.html">Service</a></li>
                <li><a href="../Motifnesia/pages/keranjang.php"><i class="fa-solid fa-cart-shopping"></i></a></li>
                ...
                <li>
                    ...
                    <?php else: ?>
                        <a href="./pages/halamanlogin2.php"><button>Login</button></a>
                    <?php endif; ?>
                </li>
            </ul>
        </nav>
