<?php
    ...
    $conn = mysqli_connect("localhost", "root", "", "tubes_webpro"); //koneksi ke database
    ...
    function tambahProduk($data, $file) {
        ...
        $targetDir = 'img/';
        if (!move_uploaded_file($tmpName, __DIR__ . '/../img/' . $namaBaru)) {
        ...
        $query = "INSERT INTO produk 
                    (gambar, nama_produk, harga, material, proses, sku, tags, stok, kategori, jenis_lengan)
                  VALUES 
                    ('$namaBaru', '$nama_produk', '$harga', '$material', '$proses', '$sku', '$tags', '$stok', '$kategori', '$jenis_lengan')";
    ...
    function filterProduk($kategori, $jenis_lengan) {
        global $conn;
