...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
        ...
        // validasi ekstensi & size (max 2MB)
        $allowedExt = ['jpg','jpeg','png','gif'];
        if (in_array($ext, $allowedExt) && $fileSize <= 2 * 1024 * 1024) {
            // buat nama unik
    ...
    // Update ke database
    $update_query = "UPDATE users SET username = '$username', email = '$email', nomor_hp = '$nomor_hp', tanggal_lahir = '$tanggal_lahir', jenis_kelamin = '$jenis_kelamin', foto = '$newFileName' WHERE id = $id";
