  ...
  <main>
    <form method="POST" action="checkOut.php">
      <div class="cart-container">
        ...
        <?php
          $harga_diskon = $item['diskon_persen'] > 0 ? $item['harga'] - ($item['harga'] * $item['diskon_persen'] / 100) : $item['harga'];
          $subtotal = $harga_diskon * $item['qty'];
        ?>
        <div class="cart-item">
          ...
          <div class="product-price">Rp<?= number_format($harga_diskon, 0, ',', '.') ?></div>
          ...
          <div class="product-subtotal subtotal-item" data-harga="<?= $subtotal ?>">Rp<?= number_format($subtotal, 0, ',', '.') ?></div>
        </div>
        <?php endforeach; ?>
      </div>
